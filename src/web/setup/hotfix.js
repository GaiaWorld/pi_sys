...
// 暂时注释，等需要用再说，需要修改pi_modules相关字段。
...
// 		util = pi_modules["pi/widget/util"].exports;
// 		widget = pi_modules["pi/widget/widget"].exports;
// 		resMgr = pi_modules["pi/util/res_mgr"].exports;
// 		changeList = [];
